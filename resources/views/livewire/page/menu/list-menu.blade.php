        ...
        <tbody>
            @foreach ($products as $product)
                <tr>
                    ...
                    <td wire:ignore>
                        <a href="#!" data-bs-toggle="modal" data-bs-target="#updateMenu{{ $product->id }}"
                            class="btn btn-warning">
                            {{-- <i data-feather="edit" class="icon-xs"></i> --}}
                            <span>Edit</span>
                        </a>
                        <div class="modal fade" id="updateMenu{{ $product->id }}" tabindex="-1" role="dialog"
                            aria-labelledby="addNewMenu" aria-hidden="true">
                            <div class="modal-dialog modal-md" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="addNewMenu">Ubah Menu</h5>
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="number" name="price" value="{{ $product->price }}"
                                                    ...
                                                    id="menu-price" placeholder="Harga Menu">
                                                @error('price')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
